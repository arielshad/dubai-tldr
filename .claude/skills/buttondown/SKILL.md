...
```bash
SUBJECT='DxbEstate Intel Daily Digest — April 18, 2026' bun -e '...' -- <markdown-path>
```
...
For DxbEstate Intel daily digests, use: `DxbEstate Intel Daily Digest — <Month> <Day>, <Year>` (em dash, not hyphen). Match the date displayed inside the markdown header.
